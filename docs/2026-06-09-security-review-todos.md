...
All 25 findings (4 High, 11 Medium, 10 Low) are fixed. This file is the per-finding
tracker: severity, affected files and lines, fix spec, resolution note, and model
assignment for each item. The narrative writeup, the commit map, and the five regressions
a follow-up code-review pass caught (CR1 through CR5) are in the review record,
[`docs/reviews/2026-06-security-fable-5.md`](reviews/2026-06-security-fable-5.md).
